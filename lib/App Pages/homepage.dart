        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: strike, // Handle search action
            ),
            IconButton(
              icon: Icon(
                Icons.support_agent,
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                ...
                                return CryptoCard(
                                  ...
                                  price: index['item']['data']['price'].toString(),
                                  marketCap: index['item']['data']['market_cap'],
                                  volume24h: index['item']['data']['total_volume'],
                                  trend30d: index['item']['data']['sparkline'],
                                  change24h: index['item']['data']['market_cap'],
                                );
                              }).toList()),
                            ),
                          )
...
class Custom_Navebar extends StatelessWidget {
  const Custom_Navebar({
    super.key,
  });
